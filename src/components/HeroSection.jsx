  ...
  return(
    <div className="flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url('/backgroundImage.png')] bg-cover bg-center h-screen">
      ...
      <div className="flex items-center gap-4 text-gray-300"> 
        ...
        <div className="flex items-center gap-1"> <Calendar1Icon className="w-4.5 h-4.5"/>2018</div>
        <div className="flex items-center gap-1"> <Clock10Icon className="w-4.5 h-4.5"/>2hr 8m</div>
      </div>
      <p className="max-w-md text-gray-300">In A Post Apocalyptic World Where Cities Ride On Wheels And Consume Each Other To Survive Two People Meet In London And Try To Stop A Conspiracy.</p>
        <button className="flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer" onClick={()=>{
          navigate('/movies')
        }}>
          Explore Movies 
